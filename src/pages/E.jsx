...
import { getenglishAPI, getmalayalamAPI } from '../Services/allAPI';
...
function E() {
  ...
  const getAllMusic = async () => {
    if (sessionStorage.getItem('token')) {
      ...
      const result = await getenglishAPI(reqHeader);
      setAllMusic(result.data);
      setFilteredMusic(result.data);  // Initially set filtered music to all music
    }
  };
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      setFilteredMusic(allMusic);  // Reset to all music if search term is empty
    }
  }, [searchTerm, allMusic]);
  ...
  return (
        ...
        <Row className="align-items-center">
          <Col md={6} className="text-center text-md-start px-4">
            ...
            <p style={{ fontSize: "1.2rem", lineHeight: "1.6" }}>
              Immerse yourself in the soulful music of Vidhu Prathap. Discover melodies that resonate and evoke deep emotions.
            </p>
            ...
            <div className="d-flex align-items-center gap-3 mt-4">
              ...
              <Form.Control
                ...
                style={{ borderRadius: "20px", backgroundColor: "#330000", color: "#fff", padding: "10px 15px", maxWidth: "130px", }}/>
              <style>
                {`
      input::placeholder {
        color: #fff !important;
    ...
    `}
          ...
          <Col md={2} className="text-center">
            {/* Updated Swetha Mohan Image */}
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkI0tltzlhDWVJkpe7Id5-zHe3aI2BYiEycQ&s"
              alt="Swetha Mohan"
              style={{ borderRadius: "20px", maxWidth: "500%", height: "auto", boxShadow: "0 10px 30px rgba(0, 0, 0, 0.5)",}}/>
          </Col>
        </Row>
      </Container>
