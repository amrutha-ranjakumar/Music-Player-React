...
import { getallteluguAPI, gettamilAPI } from '../Services/allAPI';
...
const MusicPlayer = () => {
  ...
  const getAllMusic = async () => {
    if (sessionStorage.getItem("token")) {
      ...
      const result = await getallteluguAPI(reqHeader);
    ...
    <div style={{ backgroundColor: "#1a0006", color: "#fff", minHeight: "100vh" }}>
      ...
      <Container fluid className="py-5" style={{ background: "linear-gradient(to bottom, #330000, #1a0006)" }}>
        <Row className="align-items-center">
          <Col md={7} className="text-center text-md-start px-4">
            <h1 style={{ fontSize: "3rem", fontWeight: "bold", marginBottom: "20px" }}>
              K S Chithra
            </h1>
            <p style={{ fontSize: "1.2rem", lineHeight: "1.6" }}>
              Immerse yourself in the soulful voice of K S Chithra, the Nightingale of India. Discover, explore, and cherish her timeless melodies.
            </p>
            <p style={{ margin: 0, fontSize: "1rem" }}>5,234,890 monthly listeners</p>
            <div className="d-flex align-items-center gap-3 mt-4">
              <Button variant="success" size="lg">
                Follow Us
              </Button>
              <h1><PiDotsThreeThin /></h1>
            </div>
            <Form.Control
              type="text"
              ...
              style={{ borderRadius: "20px", backgroundColor: "#330000", color: "#fff", padding: "10px 15px", maxWidth: "400px", marginTop: "20px", }} />
            <style>
              {`
          input::placeholder {
            color: #fff !important;
        ...
        `}
          ...
          <Col md={2} className="text-center">
            <img
              src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/k-s-chitra-1065653-07-03-2018-05-23-13.jpg"
              alt="K S Chithra"
              style={{ borderRadius: "20px", maxWidth: "600%", height: "auto", boxShadow: "0 10px 30px rgba(0, 0, 0, 0.5)", }} />
          </Col>
        </Row>
      </Container>
