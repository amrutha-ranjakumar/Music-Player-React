...
import { gettamilAPI } from '../Services/allAPI';
...
const MusicPlayer = () => {
  ...
  const getAllMusic = async () => {
    if (sessionStorage.getItem("token")) {
      ...
      const result = await gettamilAPI(reqHeader);
        ...
        <Row className="align-items-center">
          <Col md={6} className="text-center text-md-start px-4">
            ...
            <p style={{ fontSize: "1.2rem", lineHeight: "1.6" }}>
              Experience the magic of music with AR Rahman's timeless melodies. Discover, explore, and enjoy.
            </p>
            <p style={{ margin: 0, fontSize: "1rem" }}>6,543,567 monthly listeners</p>
  ...
  `}
          ...
          <Col md={2} className="text-center">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBMJoq8EXi9oTS44i2llYgjVAnfgS2cJWxIQ&s"
              alt="A R Rahman"
              style={{
                borderRadius: "20px",
                maxWidth: "500%",
